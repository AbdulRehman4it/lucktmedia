  ...
  // Import your videos
  import powervideo from "../assets/PFW1.webm";
  import powervideo2 from "../assets/PFW2.webm";
   import powervideo3 from "../assets/PFW3.webm";
    import powervideo4 from "../assets/PFW4.webm";

  const Powervideoslider: React.FC = () => {
    const videos = [powervideo, powervideo2, powervideo3, powervideo4]; // Add more if needed
        ...
        <div className="flex flex-col lg:flex-row items-center gap-8 sm:gap-10 md:gap-12 2xl:mt-56 mt-10 md:mt-16">
          ...
          <div className="lg:w-1/2 w-full text-center lg:text-left px-5 sm:px-8 md:px-12 xl:px-16 mb-10 md:mb-20 lg:mb-0">
            <p className="text-[#171717] 2xl:leading-10 lg:leading-[36px] leading-6 sm:leading-8 
              ...
              The new WordPress & WooCommerce eCommerce website was built to
              combine strong visuals with functionality. It features detailed,
              appealing product descriptions, an integrated blog section for SEO
              and brand storytelling, and custom-made product videos to enhance
              engagement. A key focus was placed on clearly presenting pellet
              specifications, making essential technical details easily accessible
              for users seeking a reliable and trustworthy product. Strong,
              well-crafted copy reinforces the company’s values and builds
              customer trust in the quality it represents.
            </p>
          </div>
  ...
  export default Powervideoslider;
