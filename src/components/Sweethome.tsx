...
const Sweethome: React.FC = () => {
  ...
  return (
    <>
          ...
          <div className="flex justify-start mt-16 md:mt-44 w-full lg:w-1/2">
            ...
            >
              ...
              <img
                src={sweetimg11}
                alt="Paid Ads"
                className="sweethomeimg w-[350px] md:w-[650px] lg:w-full md:top-[-160px] xl:-top-72 2xl:-top-80 -top-20 absolute right-1"
              />
            </div>
          </div>
      ...
      <section>
        <div className="margin bg-black flex flex-col lg:flex-row 2xl:items-center py-20 mt-16 lg:mt-24 2xl:mt-40">
          {/* 🔸 Left Content */}
            ...
            <div className="flex justify-center md:justify-start mt-28 lg:mt-32 2xl:mt-56 2xl:mb-28">
              ...
              >
                <video
                  ...
                  muted
                  playsInline
                  className="sweethomevideo autoplay-video lg:w-full w-3/4 rounded-xl -mt-12 md:-mt-24 lg:-mt-16 xl:-mt-20 2xl:-mt-40 md:ml-10 lg:ml-0 "
                >
